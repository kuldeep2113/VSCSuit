...
public class PageBase {
	 ...
	 * @param element
	 */
	protected void switchToIframeById(String id) {
	...
	protected void  switchToIframeByClass(WebElement  frameElement) {
	...
	protected void  switchToIframeByIndex(int i) {
	 ...
	 * @param element WebElement variable
	 */
	protected void rightClickOnElement(WebElement ele1,WebElement ele2) {
		 Actions action = new Actions(driver);
	       WebElement element =  getWebElement(ele1);
	        action.contextClick(element).build().perform();
	        WebElement element2 = getWebElement(ele2);  
	        element2.click();
	}
	...
	protected void fileUpload(By locator, String filePath) {
	  //  getWebElement(inputFieldForfile).sendKeys(filePath);
